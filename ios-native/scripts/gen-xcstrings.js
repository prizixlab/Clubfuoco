...
const NATIVE_KEYS = {
  ...
  'explore.viewEvent': { en: 'View event', es: 'Ver evento' },
  ...
  'events.schedule': { en: 'Schedule', es: 'Horario' },
  'events.stopCount': { en: '%d venues, one night', es: '%d locales, una noche' },
  ...
  'profile.friendsCount': { en: '%d friends', es: '%d amigos' },
  'profile.friendsCountOne': { en: '%d friend', es: '%d amigo' },
  'profile.friendRequests': { en: '%d waiting to be answered', es: '%d esperando respuesta' },
  'profile.friendRequestsOne': { en: '%d waiting to be answered', es: '%d esperando respuesta' },
