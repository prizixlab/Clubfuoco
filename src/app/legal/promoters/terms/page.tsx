...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Card verification. When you add a card to enable a feature that we bill through Stripe, we place a temporary authorisation of €2 on the card to confirm it is valid before we rely on it. This is not a charge: it is an authorisation hold only, is released immediately, and no money is taken. Your bank may show the hold briefly before it clears. We do not store your card details — they are held by Stripe.',
