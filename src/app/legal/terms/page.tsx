...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      'Club Fuoco is free to download and to browse — searching venues, reading listings, and joining free guest lists costs you nothing. We earn money in the ways set out below. Some features are paid; whenever you pay, the amount is always itemised and shown before you confirm.',
      'Venue commissions. Most of our revenue comes from venues that pay us a per-head commission for guests who arrive through the App. That commission is paid by the venue, not by you: it has no effect on the price the venue charges you, on access or admission, or on which venues or events appear in your feed. The rate is set by each venue and may vary by guest category — including, in some cases, by self-declared gender. If you decline to disclose gender at signup ("Prefer not to say"), settlement defaults to the higher of the applicable rates, so opting out never disadvantages you.',
      'Paid entry and VIP tables. When you book paid entry or reserve a VIP table through the App, you pay the venue’s price through our payment provider (Stripe), and Club Fuoco earns a percentage fee on the transaction. The price, any membership discount, and the total are shown before you pay. Admission remains at the venue’s discretion.',
      'Event tickets. For some events Club Fuoco acts as a reseller and adds a service fee to the ticket’s face price. The face price, the service fee, and the total are itemised at checkout before you pay.',
      'Memberships. We offer optional paid memberships (auto-renewable subscriptions billed through your Apple account) that unlock benefits such as discounts at partner venues. Membership is never required to use the App; you can manage or cancel it any time in your Apple account settings.',
      'Other fees. We also reserve the right to charge the no-show fee and the fee for admissions beyond those you paid for, both described under “Bookings, tickets and payments” below.',
    ],
  },
  {
    ...
    body: [
      ...
      'Payments for bookings and tickets are processed by our payment provider, Stripe. For venue entry and VIP tables, Club Fuoco is not the merchant of the underlying venue service and does not guarantee admission, which remains at the venue’s discretion. For event tickets, Club Fuoco may act as a reseller and add a service fee to the face price; that fee is itemised at checkout before you pay. See "How Club Fuoco makes money" above.',
